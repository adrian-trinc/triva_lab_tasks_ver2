...
public class ArrayTaskList extends TaskList {
    ...
    public void add(Task task) {
        if (Objects.isNull(task)) throw new NullPointerException("Task shouldn't be null");
    ...
    public ArrayTaskList(ArrayTaskList source) {
        ...
        this.currentCapacity = source.currentCapacity;

        this.tasks = new Task[this.currentCapacity];
        
        for (int i = 0; i < source.tasks.length; i++) {
            this.add(source.getTask(i));
        }
    }
